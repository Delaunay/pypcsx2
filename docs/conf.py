#!/usr/bin/env python
"""
pypcsx2 documentation build configuration file.
...
src_path = os.path.abspath(os.path.join(docs_src_path, "..", "pypcsx2"))
sys.path.insert(0, src_path)
src_path = os.path.abspath(os.path.join(docs_src_path, ".."))
sys.path.insert(0, src_path)


import pypcsx2.core  # noqa
...
project = "pypcsx2"
_full_version = pypcsx2.core.__version__
author = pypcsx2.core.__author__
copyright = pypcsx2.core.__copyright__
